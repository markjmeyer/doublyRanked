...
#### save output ####
setwd('~/Dropbox/Research/Drafts/Wilcoxon FDA/Simulations/MVT/pnorm/MWW/Size')
filename <- paste('mww_pnorm_t_size_', n1, '_fpca.RData', sep = '')
...
fname <- paste('mww_pnorm_', n1,'_size_t.pdf', sep = '')
pdf(fname)
