...
#### save output ####
setwd('~/Dropbox/Research/Drafts/Wilcoxon FDA/Simulations/LogNormal/pnorm/MWW/Size')
filename <- paste('mww_pnorm_l_size_', n1, '_fpca.RData', sep = '')
...
fname <- paste('mww_pnorm_', n1,'_size_l.pdf', sep = '')
pdf(fname)
boxplot(cbind(c(tabM[,,1]), c(tabM[,,2]), c(tabM[,,3]) ), col = c('forestgreen', 'mediumpurple3', 'gold2'), ylim = c(0.025, 0.065),
