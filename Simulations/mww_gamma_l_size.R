...
#### save output ####
setwd("~/Dropbox/Research/Drafts/Wilcoxon FDA/Simulations/LogNormal/gamma/MWW/Size")
filename <- paste('mww_gamma_l_size_', n1, '_fpca.RData', sep = '')
...
fname <- paste('mww_gamma_', n1,'_size_l.pdf', sep = '')
pdf(fname)
