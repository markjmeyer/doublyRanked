...
#### save output ####
setwd("~/Dropbox/Research/Drafts/Wilcoxon FDA/Simulations/MVT/gamma/MWW/Size")
filename <- paste('mww_gamma_t_size_', n1, '_fpca.RData', sep = '')
...
fname <- paste('mww_gamma_', n1,'_size_t.pdf', sep = '')
pdf(fname)
