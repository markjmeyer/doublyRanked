...
#### save output ####
setwd('~/Dropbox/Research/Drafts/Wilcoxon FDA/Simulations/Gaussian/pnorm/MWW/Size')
filename <- paste('mww_pnorm_g_size_', n1, '_fpca.RData', sep = '')
...
fname <- paste('mww_pnorm_', n1,'_size_g.pdf', sep = '')
pdf(fname)
